...
public class StaticPageController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * System.out.println(request.getRequestURI()); String pageStr=
		 * request.getRequestURI().replace("/WebSearchEngine/StaticPageController", "");
		 * System.out.println(pageStr); System.out.println(request.getPathInfo());
		 * System.out.println(
		 * "StaticPageControllerStaticPageControllerStaticPageController");
		 * 
		 * RequestDispatcher rd = request.getRequestDispatcher("E:/index.html");
